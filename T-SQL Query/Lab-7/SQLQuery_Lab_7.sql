...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '______' AND CITY = 'NULL'
...
--WHERE DEPARTMENT NOT LIKE 'NULL'
...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '%A%' AND CITY LIKE '%D' AND DEPARTMENT NOT LIKE 'NULL'
...
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME NOT LIKE '[AEIOU]' AND CITY  NOT LIKE 'NULL' AND DEPARTMENT NOT IN ('HR','IT')

--30. Display employees whose CITY is not NULL, FIRSTNAME ends with vowels, and DEPARTMENT is neither ‘HR’ nor ‘IT’.

SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '%[AEIOU]' AND CITY NOT LIKE 'NULL' AND DEPARTMENT NOT IN ('HR','IT')