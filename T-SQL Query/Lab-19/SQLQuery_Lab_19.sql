...
INTERSECT
SELECT NAME FROM CUSTOMER
WHERE MEMBERSHIP = 'GOLD' AND CITY = 'SURAT'
...
--30. Display customer IDs present in CUSTOMER table but missing from both ONLINE_CUSTOMER and OFFILNE_CUSTOMER
