...
SELECT DEPARTMENT , COUNT(EID) AS NO_OF_EMPLOYEE
FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING COUNT(EID) > 2
...
SELECT CITY, COUNT(EID) AS NO_OF_FEMALES
FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY CITY
HAVING COUNT(EID) >= 1
...
SELECT DEPARTMENT, MIN(SALARY) AS MINIMUM_SALARY_MALES
FROM EMPLOYEE
WHERE GENDER = 'MALE'
GROUP BY DEPARTMENT
HAVING MIN(SALARY) > 7000
...
SELECT CITY, MAX(SALARY) AS MAXIMUM_SALARY_FEMALES
FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY CITY
...
SELECT CITY, COUNT(EID) AS EMPLOYEE_JOINED
FROM EMPLOYEE
...
SELECT CITY, SUM(SALARY)AS TOTAL_SALARY_MALE
FROM EMPLOYEE
WHERE GENDER = 'MALE'
GROUP BY CITY
HAVING SUM(SALARY) > 15000
...
SELECT DEPARTMENT, COUNT(EID) AS EMPLOYEE_JOINED
FROM EMPLOYEE
...
SELECT CITY, COUNT(DISTINCT DEPARTMENT) AS DISTINCT_DEPART
FROM EMPLOYEE
GROUP BY CITY
...
SELECT CITY AS COUNT_MALE_FEMALE
FROM EMPLOYEE
GROUP BY CITY
--HAVING COUNT(
--			CASE 
