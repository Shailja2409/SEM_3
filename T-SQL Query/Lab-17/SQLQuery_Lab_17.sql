...
CREATE VIEW EMPLYEE_NAMEDeptSalary
AS
	SELECT FIRSTNAME,DEPARTMENT,SALARY FROM EMPLOYEE

SELECT * FROM EMPLYEE_NAMEDeptSalary
...
CREATE VIEW EMPLOYEE_NAMEContains_H
AS
	SELECT * FROM EMPLOYEE
...
CREATE VIEW EMPLOYEE_VOWEL
AS
	SELECT * FROM EMPLOYEE
	WHERE FIRSTNAME LIKE '%[AEIOU]%'

SELECT * FROM EMPLOYEE_VOWEL
